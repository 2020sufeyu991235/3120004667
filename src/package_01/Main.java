...
public class Main {
    ...
    public void continuous_contrast(List<Sentence> list_sentence_origin,List<Sentence> list_sentence_plagiarism) {
        ...
        float repeat_rate;
        for (int i = 0; i < list_sentence_plagiarism.size(); i++) {
    ...
    public int contrast(Sentence sentence_origin,Sentence sentence_plagiarism){
        ...
        List<Character> list_plagiarism=sentence_plagiarism.getList();
    ...
    public static void main(String[] args) {
        ...
        File file_plagiarism = new File("./test_text/orig_0.8_del.txt");
        Main main=new Main();
